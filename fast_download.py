...
if __name__ == '__main__':
    ...
    url = 'https://wallhaven.cc/search?categories=001&purity=110&topRange=1d&sorting=toplist&order=desc&ai_art_filter=1&page=2'

    # 图片保存文件夹
    dir = f'download/{datetime.now().year}_{datetime.now().month}_{+datetime.now().day}_2/'
